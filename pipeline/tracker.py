...
record_exception(pr_no, stage_id, error_message)
    Called when any stage fails for a PR:
      ...
      3. INSERT into ras_pipeline_exceptions
         ...
         id and timestamps are generated by DB defaults.
...
class PipelineTracker:
    ...
    # id, created_at, updated_at all use DB DEFAULT (NEWSEQUENTIALID / SYSUTCDATETIME)
    ...
    def record_exception(
        ...
        Steps (single transaction):
          ...
          3. INSERT into ras_pipeline_exceptions (ras_tracker_id, stage_id, exception_message)
             id and timestamps use DB defaults (NEWSEQUENTIALID / SYSUTCDATETIME).
        ...
        purchase_req_no:
            The PR that failed.
        stage_id:
            STAGE_ID of the stage that raised the exception.
            FK to pipeline_stages.stage_id.
        error_message:
        ...
        try:
            ...
            # 2. Fetch ras_tracker.ras_uuid_pk
            ...
            # 3. Insert exception record (id/timestamps use DB defaults)
            cursor.execute(
